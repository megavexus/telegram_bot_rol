...
class Character(object):
    ...
    _class = None
    inventory = {}
    stats = {'strength': 0, 'dexterity': 0, 'wisdom': 0,
             "intelligence": 0, "constitution": 0, "charisma": 0, "health": 0}
...
def incomingMessages(bot, update):
    ...
    if attributes == True:
        ...
        statsheet = (str(characterList[i].characterName) + "\n Created by: "
                     ...
                     + "\n Charisma: " +
                     str(characterList[i].stats['charisma'])
                     + "\n ----------------------------"
...
def alterHealth(bot, update):
    ...
    if user != DM:
        ...
        bot.sendMessage(chat_id=update.message.chat_id, text=characterList[i].characterName +
                        "'s health has been changed " + userInput[2] + " to " + str(characterList[i].stats['health']))
...
def alterGold(bot, update):
    ...
    if user != DM:
        ...
        bot.sendMessage(chat_id=update.message.chat_id, text=characterList[i].characterName +
                        "'s gold has been changed by" + userInput[2] + " to " + str(characterList[i].stats['gold']))
...
def alterExperience(bot, update):
    ...
    if user != DM:
        ...
        bot.sendMessage(chat_id=update.message.chat_id, text=characterList[i].characterName +
                        "'s XP has been changed by" + userInput[2] + " to " + str(characterList[i].stats['experience']))
